...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex flex-row justify-between items-center w-full h-20 top-0 fixed text-base text-blue-200 px-10 md:px-16 select-none backdrop-blur-sm z-50">
        <Link href={'/'}>
      ...
      {modal && <dialog className="z-30 h-screen w-full bg-transparent backdrop-blur-sm p-0 m-0 max-w-none max-h-full open:flex justify-center items-center text-lg fixed" open>
        <nav className="flex flex-col bg-primary w-fit sm:w-6/12 h-fit drop-shadow-lg rounded-md border-2 border-solid border-blue-200 text-blue-200 p-8 gap-4">
